...
export default function Restaurants() {
    ...
    /* Filters */
      ...
      <div className="px-6 py-4 bg-white border-b border-neutral-200">
        <div className="flex gap-2 overflow-x-auto">
          ...
          <Badge variant="outline" className="whitespace-nowrap">Tradicional</Badge>
          <Badge variant="outline" className="whitespace-nowrap">Frutos do Mar</Badge>
          <Badge variant="outline" className="whitespace-nowrap">Churrasco</Badge>
        </div>
      </div>
    ...
    /* Restaurants List */
      ...
      <div className="px-6 py-4">
        <div className="space-y-4">
          {restaurants.map((restaurant) => <Card key={restaurant.id} className="overflow-hidden hover:shadow-lg transition-shadow">
  ...
  />
                <div className="absolute top-3 right-3 bg-white px-3 py-1 rounded-full">
                  <span className="text-orange-700">{restaurant.price}</span>
                </div>
              </div>
              <div className="p-4">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-neutral-900 flex-1">{restaurant.name}</h3>
