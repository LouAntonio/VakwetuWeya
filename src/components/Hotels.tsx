...
interface HotelsProps {
  onNavigate: (hotelId: number) => void;
}
    ...
    <div className="min-h-full bg-neutral-50 pb-24">
      ...
      <div className="px-6 py-4 bg-white border-b border-neutral-200">
        <div className="flex gap-2 overflow-x-auto">
          <Badge variant="default" className="bg-blue-600 hover:bg-blue-700 whitespace-nowrap">
            Todos
          </Badge>
          <Badge variant="outline" className="whitespace-nowrap">Luanda</Badge>
          <Badge variant="outline" className="whitespace-nowrap">Benguela</Badge>
          <Badge variant="outline" className="whitespace-nowrap">Huambo</Badge>
        </div>
      </div>
        ...
        <div className="space-y-4">
          {hotels.map((hotel) => (
            ...
            >
              ...
              <div className="p-4">
                <h3 className="text-neutral-900 mb-2">{hotel.name}</h3>
                ...
                <div className="flex justify-between items-center pt-3 border-t border-neutral-200">
                  <div>
                    ...
                    <div className="text-blue-700">{hotel.price}</div>
                  </div>
                  <Button className="bg-blue-600 hover:bg-blue-700">Ver detalhes</Button>
                </div>
              </div>
            </Card>
          ))}
