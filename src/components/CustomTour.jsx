import { ArrowLeft, Calendar, MapPin, Check, Car, Route, ExternalLink, Info, Clock, ChevronDown, ChevronUp } from "lucide-react";
...
const destinations = [
  {
    ...
    history: "Miradouro natural formado h\xE1 milh\xF5es de anos, oferecendo uma das vistas mais impressionantes de Angola.",
    ...
    duration: "2h",
    highlights: ["Vista panor\xE2mica 360\xB0", "Fotografia profissional", "P\xF4r do sol \xFAnico"]
  },
  {
    id: 2,
    name: "Serra da Leba",
    ...
    history: "Obra-prima da engenharia portuguesa constru\xEDda nos anos 70, tornou-se s\xEDmbolo nacional de Angola.",
    ...
    duration: "1.5h",
    highlights: ["Miradouro panor\xE2mico", "Fotografia a\xE9rea", "Arquitectura impressionante"]
  },
  {
    id: 3,
    name: "Cristo Rei",
    ...
    duration: "1h",
    highlights: ["Vista da cidade", "S\xEDmbolo hist\xF3rico", "Espa\xE7o contemplativo"]
  },
  {
    id: 4,
    ...
    history: "Quedas de \xE1gua alimentadas pelos rios da regi\xE3o, criam um o\xE1sis natural no planalto.",
  ...
  },
  {
    ...
    history: "Tesouro escondido da Hu\xEDla, esta cascata \xE9 conhecida pelos locais mas pouco explorada por turistas.",
    ...
    image: "https://images.unsplash.com/photo-1593944917357-b265a76eab2f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxrYWxhbmR1bGElMjBmYWxscyUyMGFuZ29sYXxlbnwxfHx8fDE3NjMzODc2ODZ8MA&ixlib=rb-4.1.0&q=80&w=1080",
    duration: "1.5h",
    highlights: ["Trilho ecol\xF3gico", "Piscinas naturais", "Biodiversidade"]
  },
  {
    id: 6,
    ...
    history: "Fundada no per\xEDodo colonial, preserva e estuda a biodiversidade \xFAnica do planalto angolano.",
  ...
  },
  {
    ...
    history: "Reservat\xF3rio natural que se tornou ponto de encontro para fam\xEDlias e amantes da natureza.",
    ...
    duration: "1h",
    highlights: ["Piquenique familiar", "Observa\xE7\xE3o de aves", "Relaxamento"]
  },
  {
    id: 8,
    ...
    history: "Inaugurado em 1955, preserva artefactos hist\xF3ricos, etnogr\xE1ficos e art\xEDsticos da regi\xE3o.",
    ...
    image: "https://images.unsplash.com/photo-1613908853317-8606178b3e81?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhbmdvbGElMjBsYW5kc2NhcGUlMjBuYXR1cmV8ZW58MXx8fHwxNzYzMzg3Njg1fDA&ixlib=rb-4.1.0&q=80&w=1080",
    duration: "1.5h",
    highlights: ["Cultura Nhaneka-Humbe", "Arte tradicional", "Hist\xF3ria regional"]
  }
];
export default function CustomTour({ onBack, onNavigateToDestination }) {
  ...
  >
                ...
                <div className="flex-1">
                  {selectedDate ? <div>
                    ...
                    </div> : <span>Clique para escolher a data</span>}
                </div>
              </Button>
            </PopoverTrigger>
  ...
  >
            ...
            <div className="flex items-center gap-3">
              {isCardMinimized && <div className="text-right mr-2">
              ...
              <button className="w-8 h-8 rounded-full bg-teal-100 hover:bg-teal-200 flex items-center justify-center transition-colors">
                {isCardMinimized ? <ChevronDown className="w-5 h-5 text-teal-700" /> : <ChevronUp className="w-5 h-5 text-teal-700" />}
              </button>
            </div>
          </div>
    ...
    /* Price Breakdown */
                ...
                <div className="bg-white rounded-lg p-4 space-y-3 border border-teal-200">
                  ...
                  {extraLocations > 0 && <div className="flex justify-between items-center">
                      <span className="text-neutral-700">
                        {extraLocations} {extraLocations === 1 ? "local extra" : "locais extras"} (+10.000 Kz cada)
                      </span>
                      <span className="text-neutral-900">{formatPrice(extraLocations * 1e4)}</span>
                    </div>}
  ...
  >
    ...
    />
                      {isSelected && <div className="absolute inset-0 bg-teal-600/90 flex items-center justify-center">
                          <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg">
                            <Check className="w-7 h-7 text-teal-600" />
                          </div>
                        </div>}
                      {!isSelected && <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent" />}
                    </div>
    ...
    /* Route Map - Enhanced */
        ...
        {selectedCount > 0 && <Card className="p-6 mb-24 border-2 border-teal-200">
  ...
  >
    ...
    return <div key={destId}>
                        ...
                        {index < selectedDestinations.length - 1 && <div className="flex items-center justify-center py-2">
