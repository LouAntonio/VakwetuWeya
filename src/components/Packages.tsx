  ...
  return (
    <div className="min-h-full bg-neutral-50 pb-24">
      ...
      <div className="bg-emerald-600 px-6 pt-12 pb-6">
        ...
        <p className="text-emerald-100">Explora Angola com os nossos tours</p>
      </div>

      {/* Filters */}
      <div className="px-6 py-4 bg-white border-b border-neutral-200">
        <div className="flex gap-2 overflow-x-auto">
          <Badge variant="default" className="bg-emerald-600 hover:bg-emerald-700 whitespace-nowrap">
            Todos
          </Badge>
          <Badge variant="outline" className="whitespace-nowrap">Dentro da província</Badge>
          <Badge variant="outline" className="whitespace-nowrap">Fora da província</Badge>
        </div>
      </div>
                ...
                <div className="relative w-32 h-32 flex-shrink-0">
                  ...
                  {pkg.type === 'fora' && (
                    <div className="absolute top-2 left-2">
                      <Badge className="bg-orange-600 text-white">Fora</Badge>
                    </div>
                  )}
                </div>
                <div className="flex-1 py-3 pr-3 flex flex-col justify-between">
                  <div>
                    <h3 className="text-neutral-900 mb-1">{pkg.name}</h3>
