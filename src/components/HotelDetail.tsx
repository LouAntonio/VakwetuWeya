...
const hotelData: Record<number, any> = {
  1: {
    name: 'Hotel Trópico',
    ...
    reviews: 324,
    price: '85.000 Kz',
    description: 'Hotel de luxo situado na Marginal de Luanda, com vistas espetaculares para o mar e acesso direto à praia. Quartos modernos e elegantes com todas as comodidades.',
    images: [
    ...
    amenities: [
      ...
      { icon: Coffee, label: 'Pequeno-almoço incluído' },
      { icon: Car, label: 'Estacionamento grátis' },
      { icon: Waves, label: 'Piscina' },
      { icon: Dumbbell, label: 'Ginásio' },
  ...
  2: {
    ...
    reviews: 189,
    price: '65.000 Kz',
    description: 'Pousada acolhedora junto ao mar em Benguela. Perfeita para quem procura tranquilidade e contacto com a natureza. Vista direta para o oceano Atlântico.',
    images: [
  ...
  3: {
    ...
    reviews: 156,
    price: '95.000 Kz',
    description: 'Lodge exclusivo no coração da natureza angolana. Experiência única com safari tours e observação de fauna selvagem. Quartos rústicos de luxo.',
    images: [
    ...
    amenities: [
      ...
      { icon: UtensilsCrossed, label: 'Safari tours incluídos' },
      { icon: Coffee, label: 'Bar' },
      { icon: Car, label: 'Transfer incluído' },
    ],
...
// Use hotel 1 as fallback for other hotels
const getHotelData = (id: number) => {
