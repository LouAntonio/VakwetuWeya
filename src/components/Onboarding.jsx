...
const slides = [
	{
		...
		description:
			"Descobre a beleza e diversidade de Angola atrav\xE9s de experi\xEAncias aut\xEAnticas e memor\xE1veis",
	...
	},
	{
		...
		description:
			"Pacotes personalizados, guias especializados e as melhores rotas para conhecer o pa\xEDs",
	...
	},
	{
		...
		description:
			"Tudo o que precisas para a tua aventura angolana, na palma da tua m\xE3o",
	...
	return (
		<div className="h-full flex flex-col bg-white">
			...
			<div className="bg-white px-6 py-8 rounded-t-3xl -mt-8 relative z-10">
				...
				<h1 className="text-neutral-900 mb-3 text-center">
