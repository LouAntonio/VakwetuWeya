...
const destinationData = {
  1: {
    ...
    activities: ["Fotografia", "Observa\xE7\xE3o de paisagem", "Piquenique"]
  },
  2: {
    name: "Serra da Leba",
    location: "Hu\xEDla",
    ...
    activities: ["Fotografia", "Aprecia\xE7\xE3o arquitet\xF3nica", "Observa\xE7\xE3o"]
  },
  3: {
    name: "Cristo Rei",
    location: "Lubango",
  ...
  >
    ...
    /* Highlights */
        ...
        <Card className="p-6 mb-6">
          ...
          <ul className="space-y-3">
            {destination.highlights.map((highlight, index) => <li key={index} className="flex items-start gap-3">
    ...
    /* Activities */
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            {destination.activities.map((activity, index) => <Badge key={index} className="bg-emerald-100 text-emerald-700 hover:bg-emerald-100">
                {activity}
              </Badge>)}
          </div>
        </Card>
    ...
    /* Tips */
        ...
        <Card className="p-6 mb-24 bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
          ...
          <ul className="space-y-3">
            {destination.tips.map((tip, index) => <li key={index} className="flex items-start gap-3">
