    ...
    /* Destinations */
      ...
      <div className="px-6 mt-6">
        ...
        <div className="space-y-4">
          {destinations.map((destination) => <Card key={destination.id} className="overflow-hidden">
  ...
  />
                ...
                <div className="flex-1 py-3 pr-3 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="flex gap-2">
                      {destination.has360 && <Badge variant="outline" className="border-emerald-600 text-emerald-700">
                          360°
                        </Badge>}
                      {destination.hasAR && <Badge variant="outline" className="border-purple-600 text-purple-700">
                          RA
                        </Badge>}
                    </div>
                  </div>
              ...
              <div className="p-4 bg-neutral-50 border-t border-neutral-200">
                <div className="flex gap-2">
                  ...
                  {destination.hasAR && <Button className="flex-1 bg-purple-600 hover:bg-purple-700">
