...
const quickAccess = [
  { icon: Package, label: "Pacotes", screen: "packages", color: "bg-emerald-100 text-emerald-700" },
  { icon: Hotel, label: "Hot\xE9is", screen: "hotels", color: "bg-blue-100 text-blue-700" },
  { icon: UtensilsCrossed, label: "Restaurantes", screen: "restaurants", color: "bg-orange-100 text-orange-700" },
  { icon: ShoppingBag, label: "Artesanato", screen: "crafts", color: "bg-purple-100 text-purple-700" },
  { icon: Glasses, label: "RA 360\xB0", screen: "ar360", color: "bg-pink-100 text-pink-700" }
];
