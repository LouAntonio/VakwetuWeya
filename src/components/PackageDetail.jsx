...
const packageData = {
  1: {
    ...
    description: "Visita as espetaculares Cataratas de Kalandula, uma das maiores quedas de \xE1gua de \xC1frica, e explora as maravilhas naturais da prov\xEDncia de Malanje.",
    ...
    /* Itinerary */
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="space-y-4">
            {pkg.itinerary.map((item, index) => <div key={index} className="flex gap-4">
    ...
    /* Includes */
        ...
        <Card className="p-6 mb-6">
          ...
          <ul className="space-y-2">
            {pkg.includes.map((item, index) => <li key={index} className="flex items-start gap-2">
