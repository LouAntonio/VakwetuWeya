...
const packageData = {
	1: {
		...
		description:
			"Visita as espetaculares Cataratas de Kalandula, uma das maiores quedas de \xE1gua de \xC1frica, e explora as maravilhas naturais da prov\xEDncia de Malanje.",
		groupSize: "2-12 pessoas",
		includes: [
			"Transporte ida e volta",
			"Guia tur\xEDstico especializado",
			"Alojamento (2 noites)",
			"Refei\xE7\xF5es inclu\xEDdas",
			"Seguro de viagem",
		],
		itinerary: [
			{
			...
			},
			{
				...
				description: "Visita \xE0s forma\xE7\xF5es rochosas \xFAnicas",
			},
			{
				day: "Dia 3",
				title: "Mercado Local",
				description: "Experi\xEAncia cultural no mercado tradicional",
			},
		],
	},
	2: {
		...
		includes: [
			...
			"Alojamento (4 noites)",
			"Todas as refei\xE7\xF5es",
			"Equipamento de seguran\xE7a",
			"\xC1gua mineral",
		],
		itinerary: [
			{
				...
				description: "Aclimata\xE7\xE3o e prepara\xE7\xE3o",
			},
			{
				day: "Dia 2",
				title: "Dunas de Areia",
				description: "Explora\xE7\xE3o das maiores dunas",
			},
			{
				day: "Dia 3",
				title: "Welwitschia Mirabilis",
				description: "Visita \xE0s plantas milenares",
			},
			{
				day: "Dia 4",
				title: "Serra da Leba",
				description: "Paisagens montanhosas incr\xEDveis",
			},
			{
				day: "Dia 5",
	...
	3: {
		...
		includes: ["Transporte", "Guia tur\xEDstico", "Almo\xE7o na praia"],
		itinerary: [
			{
				day: "Manh\xE3",
			...
			},
			{
				...
				description: "Nata\xE7\xE3o e relaxamento",
			},
			{
				day: "Noite",
				title: "Jantar na praia",
				description: "P\xF4r do sol e refei\xE7\xE3o",
			},
		],
	},
};
