...
const slides = [
  {
    ...
    description: 'Descobre a beleza e diversidade de Angola através de experiências autênticas e memoráveis',
  ...
  },
  {
    ...
    description: 'Pacotes personalizados, guias especializados e as melhores rotas para conhecer o país',
  ...
  },
  {
    ...
    description: 'Tudo o que precisas para a tua aventura angolana, na palma da tua mão',
          ...
          {slides.map((_, index) => (
            <div
              ...
              className={`h-1.5 rounded-full transition-all ${
                index === currentSlide ? 'w-8 bg-emerald-600' : 'w-1.5 bg-neutral-300'
              }`}
            />
          ))}
        </div>
