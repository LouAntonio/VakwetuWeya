...
const hotelData = {
	1: {
		...
		price: "85.000 Kz",
		description:
			"Hotel de luxo situado na Marginal de Luanda, com vistas espetaculares para o mar e acesso direto \xE0 praia. Quartos modernos e elegantes com todas as comodidades.",
		images: [
	...
	2: {
		...
		price: "65.000 Kz",
		description:
			"Pousada acolhedora junto ao mar em Benguela. Perfeita para quem procura tranquilidade e contacto com a natureza. Vista direta para o oceano Atl\xE2ntico.",
		images: [
	...
	3: {
		...
		price: "95.000 Kz",
		description:
			"Lodge exclusivo no cora\xE7\xE3o da natureza angolana. Experi\xEAncia \xFAnica com safari tours e observa\xE7\xE3o de fauna selvagem. Quartos r\xFAsticos de luxo.",
		images: [
				...
				<Card className="p-6 mb-6">
					...
					<div className="space-y-3">
						<a
							...
							className="flex items-center gap-3 text-neutral-700 hover:text-blue-700"
						>
							<div className="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center flex-shrink-0">
